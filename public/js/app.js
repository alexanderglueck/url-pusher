...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  var urlInput = pushForm.querySelector('input#url');
  var deviceSelect = pushForm.querySelector('select#device_id');
  document.querySelectorAll('a.push-again-link').forEach(function (anchor) {
  ...
  var forms = document.querySelectorAll(".confirm-delete");
  ...
  var copyToClipboardButtons = document.querySelectorAll(".copy-to-clipboard");

  if (copyToClipboardButtons.length > 0) {
    var _iterator2 = _createForOfIteratorHelper(copyToClipboardButtons),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var copyToClipboardButton = _step2.value;
